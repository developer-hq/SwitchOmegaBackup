var FindProxyForURL = function(init, profiles) {
    ...
    "+__ruleListOf_auto switch": function(url, host, scheme) {
        ...
        if (/(?:^|\.)tw\.money\.yahoo\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)7-zip\.org$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)esu\.dog$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)pinterest\.com\.mx$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)yiyechat\.com$/.test(host)) return "+proxy";
